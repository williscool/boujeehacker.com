...
export default async function SiteLayout({
  ...
  return (
    <>
      <Script id="segment_with_posthog" strategy="afterInteractive">{`
        var SEGMENT_API_KEY = '${process.env.NEXT_PUBLIC_SEGMENT_API_KEY ?? ""}';
        var POSTHOG_API_KEY = '${process.env.NEXT_PUBLIC_POSTHOG_API_KEY ?? ""}';
      ...
      <Script id="rudderstack" strategy="afterInteractive">{`
        var RUDDERSTACK_API_KEY = '${process.env.NEXT_PUBLIC_RUDDERSTACK_API_KEY ?? ""}';
