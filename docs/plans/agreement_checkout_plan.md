...
- **Invoice memo (manual step, every invoice)**: the memo must reference the current agreement version's date and permanent URL, e.g. "Payment constitutes acceptance of the Consulting Agreement (2026-07-23) at https://boujeehacker.com/agreement/2026-07-23". When the agreement is versioned up, the memo text updates with it. Keep the current memo line saved as a snippet next to wherever the standard rate lives.
